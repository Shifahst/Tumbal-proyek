        ...
        <section class="my-5 sm:my-10">
            ...
            <div class="sm:grid lg:grid-cols-4 sm:grid-cols-3 gap-4">
                ...
                <div class="lg:col-span-3 sm:col-span-2 px-2 lg:px-6 mt-5 sm:mt-0 text-sm sm:text-base">
                    ...
                    <p>Having contributions in developing human resources and to developing professional skillfull labor according to the Republic Indonesia Government’s program.
PT. DUA UTAMA JAYA as a strategic option to works and as a bridge to reach the career successfully in the future.</p>
